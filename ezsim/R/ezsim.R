...
ezsim <-
function(m,estimator,dgp,parameter_def,true_value=NULL,display_name=NULL,estimator_parser=NULL,auto_save=0,parallel=TRUE,number_of_workers=detectCores(),run=TRUE,run_test=TRUE){
